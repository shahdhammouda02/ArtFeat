      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
        ...
        <div className="h-full flex flex-col justify-between space-y-4">
          ...
          <div className="bg-white border-2 border-sky-100 rounded-xl p-4">
            <h3 className="text-base font-semibold text-gray-900 mb-3 text-center">Time Remaining</h3>
            <div className="grid grid-cols-4 gap-3 text-center">
              <div className="bg-sky-50 rounded-lg p-2">
                <div className="text-xl lg:text-2xl font-bold text-sky-600">{String(d).padStart(2, "0")}</div>
                <div className="text-xs font-medium text-gray-600 tracking-wide">DAYS</div>
              </div>
              <div className="bg-sky-50 rounded-lg p-2">
                <div className="text-xl lg:text-2xl font-bold text-sky-600">{String(h).padStart(2, "0")}</div>
                <div className="text-xs font-medium text-gray-600 tracking-wide">HOURS</div>
              </div>
              <div className="bg-sky-50 rounded-lg p-2">
                <div className="text-xl lg:text-2xl font-bold text-sky-600">{String(m).padStart(2, "0")}</div>
                <div className="text-xs font-medium text-gray-600 tracking-wide">MINUTES</div>
              </div>
              <div className="bg-sky-50 rounded-lg p-2">
                <div className="text-xl lg:text-2xl font-bold text-sky-600">{String(s).padStart(2, "0")}</div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-5">
            <h3 className="text-base font-semibold text-gray-900 mb-3">Place Your Bid</h3>
            ...
            <div className="mb-3 p-3 bg-sky-50 border border-sky-200 rounded-xl">
              ...
              <div className="flex gap-2 mb-2">
                <button
                  type="button"
                  onClick={() => {
                    const input = document.querySelector('input[name="bid"]') as HTMLInputElement;
                ...
                <button
                  ...
                  onClick={() => {
                    const input = document.querySelector('input[name="bid"]') as HTMLInputElement;
                    if (input) input.value = (currentBidNum + 1000).toString();
                  }}
                  className="px-3 py-1.5 bg-white border border-gray-300 rounded-md text-sm font-medium text-sky-600 hover:bg-sky-50 hover:border-sky-300 transition-colors"
                >
                ...
                <button
                  ...
                  onClick={() => {
                    const input = document.querySelector('input[name="bid"]') as HTMLInputElement;
                    if (input) input.value = (currentBidNum + 1500).toString();
                  }}
                  className="px-3 py-1.5 bg-white border border-gray-300 rounded-md text-sm font-medium text-sky-600 hover:bg-sky-50 hover:border-sky-300 transition-colors"
                >
