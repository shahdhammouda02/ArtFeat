    ...
    <div className="rounded-xl border border-gray-200 overflow-hidden bg-white shadow-sm">
      <table className="w-full">
        <thead className="bg-sky-50">
          <tr>
            <th className="px-6 py-4 text-left font-semibold text-gray-900 text-sm">Bidder</th>
            <th className="px-6 py-4 text-left font-semibold text-gray-900 text-sm">Amount</th>
            <th className="px-6 py-4 text-left font-semibold text-gray-900 text-sm">Time</th>
          </tr>
        </thead>
