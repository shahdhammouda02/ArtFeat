        ...
        <div className="grid items-center gap-8 md:gap-12 md:grid-cols-2">
          <div className="order-2 md:order-1">
            ...
            <div className="mt-8 md:mt-4 lg:mt-8">
              <Link to="/events" aria-label="Go to Events page">
                <Button className="bg-sky-500 hover:bg-sky-600 text-white font-semibold text-lg px-8 py-4 rounded-lg shadow-md transition-all duration-300 hover:shadow-lg">
                  Explore Events
                  <svg
